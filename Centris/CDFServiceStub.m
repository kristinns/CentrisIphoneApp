...
+ (NSArray *)getAssignmentsForCourseWithCourseID:(NSString *)courseID inSemester:(NSString *)semester
{
    if ([courseID isEqualToString:@"T-109-INTO"] && [semester isEqualToString:@"20113"])
    {
        ...
        [assignment1 setObject:[NSNumber numberWithDouble:7.3] forKey:@"Grade"];
        [assignment1 setObject:@"Computations are fundamental shit yo" forKey:@"StudentMemo"];
        [assignment1 setObject:@"Yes it is! But your solution sucked" forKey:@"TeacherMemo"];
        [assignment1 setObject:@"2013-10-23T23:44:20" forKey:@"Closes"];
